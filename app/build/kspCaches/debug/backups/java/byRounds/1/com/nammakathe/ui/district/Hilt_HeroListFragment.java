...
public abstract class Hilt_HeroListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HeroListFragment() {
    super();
  }

  Hilt_HeroListFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HeroListFragment_GeneratedInjector) this.generatedComponent()).injectHeroListFragment(UnsafeCasts.<HeroListFragment>unsafeCast(this));
    }
  }
