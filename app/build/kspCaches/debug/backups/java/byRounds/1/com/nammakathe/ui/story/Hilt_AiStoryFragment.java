...
public abstract class Hilt_AiStoryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AiStoryFragment() {
    super();
  }

  Hilt_AiStoryFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AiStoryFragment_GeneratedInjector) this.generatedComponent()).injectAiStoryFragment(UnsafeCasts.<AiStoryFragment>unsafeCast(this));
    }
  }
