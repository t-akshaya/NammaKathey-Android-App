...
public abstract class Hilt_BadgeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BadgeFragment_GeneratedInjector) this.generatedComponent()).injectBadgeFragment(UnsafeCasts.<BadgeFragment>unsafeCast(this));
    }
  }
