  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUserEntity = new EntityInsertionAdapter<UserEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `users` (`id`,`fullName`,`email`,`password`,`ageGroup`,`isGuest`,`avatarIndex`) VALUES (?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(5, entity.getAgeGroup());
        final int _tmp = entity.isGuest() ? 1 : 0;
        statement.bindLong(6, _tmp);
        statement.bindLong(7, entity.getAvatarIndex());
      }
    };
  }
      ...
      public UserEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new UserEntity(_tmpId,_tmpFullName,_tmpEmail,_tmpPassword,_tmpAgeGroup,_tmpIsGuest,_tmpAvatarIndex);
          } else {
            _result = null;
          }
          return _result;
