...
public abstract class Hilt_StatueFinderFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_StatueFinderFragment() {
    super();
  }

  Hilt_StatueFinderFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StatueFinderFragment_GeneratedInjector) this.generatedComponent()).injectStatueFinderFragment(UnsafeCasts.<StatueFinderFragment>unsafeCast(this));
    }
  }
