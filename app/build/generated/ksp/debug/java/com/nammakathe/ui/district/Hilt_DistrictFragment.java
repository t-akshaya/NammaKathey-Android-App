...
public abstract class Hilt_DistrictFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DistrictFragment() {
    super();
  }

  Hilt_DistrictFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DistrictFragment_GeneratedInjector) this.generatedComponent()).injectDistrictFragment(UnsafeCasts.<DistrictFragment>unsafeCast(this));
    }
  }
